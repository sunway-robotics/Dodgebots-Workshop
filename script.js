    ...
    const welcomecompButton = document.getElementById("welcomp");
    ...
    const welcomecompContent = document.getElementById("welcomp");
...
function welcome() {
    ...
    welcomecompButton.style.fontWeight = "normal";
    ...
    welcomecompContent.style.display = "none";
}
...
function welcomp() {
    ...
    tutorial2Button.style.fontWeight = "normal";
    welcomecompButton.style.fontWeight = "bold";

    // 2. ⭐ CORRECTIVE ACTION: Show/Hide Content
    welcomeContent.style.display = "none"; // SHOW Welcome
    tutorial1Content.style.display = "none";  // HIDE Tutorial 1
    tutorial2Content.style.display = "none";  // HIDE Tutorial 2
    welcomecompContent.style.display = "block";
}
